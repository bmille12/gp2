...
bool CGameApplication::initGame()
{
	...
	{
		MessageBox(NULL,TEXT("The FX File cannot be located. You're a fanny. Please run this executable from the directory that contains the FX File."),TEXT("Error"),MB_OK);
		return false;
	}
